...
import { Injectable, Component, OnInit, ChangeDetectionStrategy, HostListener, ChangeDetectorRef, ApplicationRef } from '@angular/core';
...
export class MotionSensorService implements OnInit {
